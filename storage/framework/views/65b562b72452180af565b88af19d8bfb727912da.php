<header id="header" class="full-header" data-mobile-sticky="true">
        ...
        ============================================= -->
          ...
          <div id="logo">
            <a
              ...
              ><img src="<?php echo e($web_information->image->logo_header_dark ?? ''); ?>" alt="Canvas Logo"
            /></a>
            <a
              href="index-2.html"
              class="retina-logo"
  ...
  <!-- #header end --><?php /**PATH C:\xampp\htdocs\FHM_Watches\resources\views/frontend/blocks/header/styles/default.blade.php ENDPATH**/ ?>