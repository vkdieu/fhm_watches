            ...
            <div class="bg-overlay">
              ...
              >
                ...
                >
                  ...
                  <span><?php echo e(isset($item->json_params->price) && $item->json_params->price > 0 ? number_format($item->json_params->price, 0, ',', '.') . ' đ' : __('Contact')); ?></span>
                </div>
                <!-- Description: End -->
                <div class="d-flex">
                  <a
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\FHM_Watches\resources\views/frontend/blocks/cms_product/styles/default.blade.php ENDPATH**/ ?>