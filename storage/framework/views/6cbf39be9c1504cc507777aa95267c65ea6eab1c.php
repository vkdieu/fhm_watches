  ...
  <section id="page-title">
    ...
    <div class="container clearfix">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('frontend.cms.post')); ?>"><?php echo e($page->name ?? ''); ?></a></li>
      </ol>
    </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\phanlong\resources\views/frontend/pages/post/category.blade.php ENDPATH**/ ?>