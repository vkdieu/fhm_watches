  ...
  (SEMICOLON.initialize = {
    ...
    execPlugin: function (e, i, n) {
      ...
      n
        ? (i.trigger &&
            !scwEvents[i.trigger] &&
            (l.trigger(i.trigger), (scwEvents[i.trigger] = !0)),
    ...
    (SEMICOLON.header = {
      ...
      menufunctions: function () {
        ...
        (r = Number(r)),
          ...
          (o.hasClass("device-xl") || o.hasClass("device-lg"))
            ? t.off("click").on("click", function (i) {
                ...
                n
                  ...
                  .stop(!0, !0)
                  .slideUp(r),
                  n.parent(l).children(s).stop(!0, !0).slideToggle(r),
                  i.preventDefault();
              })
            : (o.hasClass("side-header") && b.hasClass("on-click")) ||
          ...
          (o.hasClass("device-xl") || o.hasClass("device-lg")) &&
            b.find(".mobile-primary-menu").removeClass("d-block");
      },
          ...
          e(t.target).closest(".top-search-form").length ||
            ...
            e(t.target).closest(".primary-menu.on-click").length ||
              (b
                ...
                .find(".d-block")
                .removeClass("d-block"),
              b.filter(".on-click").find(".menu-item").removeClass("current")),
      ...
      extras: function () {
        ...
        if (
          ...
          let i = e("[data-adaptive-light-class], [data-adaptive-dark-class]"),
            ...
            s = function (e) {
              e
                ? (o.toggleClass("dark", !0), i.removeClass(n).addClass(t))
                : (o.toggleClass("dark", !1), i.removeClass(t).addClass(n)),
                SEMICOLON.header.logo();
            };
          window.matchMedia &&
